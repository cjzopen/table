/*
 * JTSage-DateBox
 * For: bootstrap4; With: flipbox, slidebox
 * Date: 2018-06-04T09:12:25.078Z
...
(function($) {
    $.widget("jtsage.datebox", {
        ...
        _create: function() {
            ...
            if (o.useButton) {
                $("<div class='input-group-append' " + ">" + "<span class='input-group-text " + o.icnCls + o.buttonIcon + "'></span>" + "</div>").attr("title", w.__("tooltip")).on(o.clickEvent, function(e) {
                    e.preventDefault();
                    if (o.useFocus) {
                        w.d.input.focus();
                    } else {
